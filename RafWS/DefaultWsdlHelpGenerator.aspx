...
<html>
    ...
    Uri TryPostUrl {
        get {
            ...
            /////////////////////////
            if (
                 (postUrl.ToString().StartsWith("http://190.14.206.26") ) &&
                 (!postUrl.ToString().StartsWith("http://190.14.206.26:28888") )
               )
            {
                string newUri;
                newUri = postUrl.ToString().Replace("http://190.14.206.26", "http://190.14.206.26:28888").ToString();
                postUrl = new Uri(newUri);
            }   
            ////////////////////////
            ////////////////////////
            return postUrl;
                  ...
                  <% }
                      ...
                      <form target="_blank" action='<%#TryGetUrl == null ? "" : TryGetUrl.AbsoluteUri%>' method="GET">
                        ...
                        <footertemplate>
                          <tr>
                            <td></td>
                            <td align="right"> <input type="submit" value="<%#GetLocalizedText("InvokeButton")%>" class="button">ok</td>
                          </tr>
                          </table>
                        </footertemplate>
                    </asp:repeater>
